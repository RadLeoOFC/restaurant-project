...
return [
    ...
    'save_desk_position' => 'Запазване на позицията',
    'confirm_desk_move' => 'Искате ли да запазите новата позиция на бюрото?',
    'cancel' => 'Отказ',

    'reservation_details' => 'Информация за резервацията',
    'desk_details' => 'Управление на бюро',

    'search_by_key' => 'Търси по ключ',
    'clear' => 'Изчисти',
    'filter' => 'Филтър',
];
